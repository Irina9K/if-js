...
function searchCountry(nameCountry) {
  const nameLower = nameCountry.toLowerCase();
  const hotelFilter = hotels.filter((item) => item.country.toLowerCase() === nameLower);
